...
public class UpdateTaskRequest {
    ...
    private Boolean attachmentsUpdate;
    ...
    public Boolean getAttachmentsUpdate() {
        return attachmentsUpdate;
    }

    public void setAttachmentsUpdate(Boolean attachmentsUpdate) {
        this.attachmentsUpdate = attachmentsUpdate;
    }
}
